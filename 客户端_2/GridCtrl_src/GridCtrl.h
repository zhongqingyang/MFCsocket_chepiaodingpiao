...
public:
	...
	BOOL SetCustomFixedRow(int nFixedRows =2);//lgp add
    ...
    void     SetFixedTextColor(COLORREF clr) { m_cellFixedRowDef.SetTextClr(clr); 
	                                           ...
	                                           m_cellFixedColDef.SetTextClr(RGB(228,243,249));//fixed by hc@cczu.edu.cn
											   m_cellFixedRowColDef.SetTextClr(RGB(0,0,255));}
